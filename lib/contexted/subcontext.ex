defmodule Contexted.Subcontext do
  @moduledoc """
  The `Contexted.Subcontext` module generates common CRUD functions for a context, similar what generates the following Phoenix generator:
  ...
  - `list_{resource plural name}` - Lists all resources in the schema.
  ...
  {resource name} and {resource plural name} will be replaced by the singular and plural forms of the resource name.
  """
  ...
  defmacro __using__(opts) do
    ...
    quote bind_quoted: [
      ...
      unless :list in exclude do
        ...
        @doc """
        Returns a list of all #{resource_name_plural} from the database.

        ## Examples

            iex> list_#{resource_name_plural}()
