...
The goal of the Code of Conduct is to specify a baseline standard of behavior so that people with different social values and communication styles can talk about Contexted effectively, productively, and respectfully, even in face of disagreements. The Code of Conduct also provides a mechanism for resolving conflicts in the community when they arise.

## Our Values

These are the values Contexted developers should aspire to:
...
If you contribute to or support Contexted in any way, you are encouraged to follow the Code of Conduct while doing so.

Explicit enforcement of the Code of Conduct applies to the official mediums operated by the Contexted project:

* The official [Contexted][1] GitHub project and code reviews.
* The official [Contexted channel][5] in Elixir's Slack workspace.
...
[0]: mailto:contact@curiosum.com?subject=Contexted:%20Code%20of%20Conduct%20Report
[1]: https://github.com/curiosum_dev/contexted/
[5]: https://elixir-lang.slack.com/archives/C099FL2MAA0
